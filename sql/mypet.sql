...
CREATE TABLE `t_address` (
  ...
  `full_address` varchar(255) NOT NULL COMMENT '具体住址',
  `district` varchar(255) NOT NULL COMMENT '详细住址(省市县+具体住址)',
  `state` int(11) NOT NULL COMMENT '0表示默认地址 1表示普通地址',
  `user_code` varchar(11) NOT NULL COMMENT '用户编号',
...
CREATE TABLE `t_admin` (
  ...
  `admin_password` varchar(255) NOT NULL COMMENT '管理员账号密码',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_adopt` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `adopt_code` varchar(255) NOT NULL,
  `adopt_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `adopt_state` int(11) NOT NULL COMMENT '是否同意被领养,0表示不同意,1是还在审核,2是同意',
  `pet_code` varchar(255) NOT NULL,
...
CREATE TABLE `t_pet` (
  ...
  `pet_birthday` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '宠物生日',
...
-- ----------------------------
-- Table structure for `t_pet_image`
-- ----------------------------
DROP TABLE IF EXISTS `t_pet_image`;
CREATE TABLE `t_pet_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pet_code` varchar(255) NOT NULL,
